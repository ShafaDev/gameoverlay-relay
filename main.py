"""
GameOverlay Relay Server - REPLIT DEPLOYMENT VERSION
Optimized for Replit Autoscale with fast health checks
"""
...
app = Flask(__name__)
app.config['SECRET_KEY'] = os.environ.get('SECRET_KEY', 'gameoverlay-replit-2024')
CORS(app)

# Optimized SocketIO settings for deployment
socketio = SocketIO(
    app, 
